...
Mais derrière, on a une généricité de l'application à toute épreuve, qui vont permettre d'enrichir l'application à moindre frais, quelque soit les évolutions futures de l'application, et avec très peu de code.
...
Les développeurs Java ont très vite travailler plus sur les méthodes de développement que sur le langage en lui-même.<br/>
